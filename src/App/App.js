...
export class App extends BaseComponent {
  ...
  setLocalStorage = () => {
    localStorage.setItem('ArtQuiz_state_LenarFF4', JSON.stringify(state));
  };

  getLocalStorage = () => {
    if (localStorage.getItem('ArtQuiz_state_LenarFF4')) {
      const localStorageInfo = JSON.parse(localStorage.getItem('ArtQuiz_state_LenarFF4'));
